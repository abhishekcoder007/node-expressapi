...
const updateStudent=(req,res)=>{
    ...
    let sql= "UPDATE users SET ? WHERE id=?";
      ...
      const updateStudentMarks=(req,res)=>{
        ...
        let sql= "UPDATE student_details SET ? WHERE id=?";
          ...
          const studentDetails=(req,res)=>{
            ...
            if(data){
              let sql = "SELECT users.name, student_details.maths, student_details.physics, student_details.chemistry FROM users INNER JOIN student_details ON users.id = student_details.id WHERE users.username=?";
      ...
      module.exports={updateStudent,studentLogin,profileUpdateStudent,updateStudentMarks,studentDetails};